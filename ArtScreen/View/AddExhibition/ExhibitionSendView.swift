...
private let reuseIdentidier = "ExhibitionSendCell"
...
//        addStackView_V()
    ...
    func configureUI() {
        ...
        tableView.register(ExhibitionSendCell.self, forCellReuseIdentifier: reuseIdentidier)
...
extension ExhibitionSendView: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: reuseIdentidier, for: indexPath) as! ExhibitionSendCell
